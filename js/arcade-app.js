...
/* Create an empty arry to store the opened cards */
let openIcons = [];
...
function CheckGameEnded() {
  if (openIcons.length == icons.length) { //if the icons that are "open"(seen on the screen) are equal the number of icons in the array
